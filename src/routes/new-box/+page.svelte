      ...
      <div class="cell pt-5">
        <div class="card">
          <div class="card-content">
              ...
              <p>Get access starting when the location opens lasting until the location closes for the day.</p>
              <button class="button mt-5">Select Box</button>
          </div>
        </div>
      </div>
      <div class="cell">
        <div class="card" style="height: 100%">
          <div class="card-content">
              ...
              <button class="button is-primary is-outlined mt-5">Select Box</button>
          </div>
        </div>
      </div>
      <div class="cell pt-5">
        <div class="card">
          <div class="card-content">
              ...
              <p class="is-italic mt-2">Includes 1 free transfer to another location</p>
              <button class="button mt-5">Select Box</button>
          </div>
        </div>
      </div>
